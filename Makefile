...
am__append_1 = neural_networks/runtime cube
subdir = .
...
ACLOCAL = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_CPPFLAGS =  -O2 -DNDEBUG
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/missing autoconf
AUTOHEADER = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/missing autoheader
AUTOMAKE = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/missing automake-1.14
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -I/usr/local/include/leptonica -pthread -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12  
CXX = g++
CXXCPP = g++ -E
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 3.05.00dev
abs_builddir = /home/zhijian/Documents/Research/tesseract
abs_srcdir = /home/zhijian/Documents/Research/tesseract
abs_top_builddir = /home/zhijian/Documents/Research/tesseract
abs_top_srcdir = /home/zhijian/Documents/Research/tesseract
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/zhijian/Documents/Research/tesseract/config/install-sh
...
doc: doc-dummy
	...
	version="3.05.00dev" name="tesseract" \
	doxygen $(top_srcdir)/doc/Doxyfile

doc-pack: doc
	-chmod a+r $(top_srcdir)/doc/html/*
	 @tar --create --directory=$(top_srcdir)/doc/html --verbose --file=- . | gzip -c -9 > $(top_srcdir)/tesseract-3.05.00dev-doc-html.tar.gz;
